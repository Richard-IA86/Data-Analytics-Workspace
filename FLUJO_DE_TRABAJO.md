...
`Colab -> Archivo -> Abrir bloc de notas -> pestaña GitHub`

*Nota sobre Google Drive:* Nuestro flujo principal **omite** Google Drive para evitar desincronizaciones. Colab siempre sugerirá "Copiar en Drive", pero **ignora ese botón**. Si guardas en Drive, esa copia quedará huérfana de nuestro control de versiones. Si por algún motivo específico necesitas una copia en Drive, debes subir manualmente el archivo `.ipynb` desde tu pc local (`C:\Dev\Data Analytics\TPX\...`) a tu cuenta de Drive.
